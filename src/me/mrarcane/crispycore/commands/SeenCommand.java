...
import static me.mrarcane.crispycore.utils.PlayerUtil.timePlayer;
...
public class SeenCommand implements CommandExecutor {
    private void playerHomes(CommandSender player, OfflinePlayer target) {
        PlayerUtil user = new PlayerUtil(target.getUniqueId().toString());
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
            ...
            PlayerUtil user = new PlayerUtil(t.getUniqueId().toString());
