...
import me.mrarcane.crispycore.managers.ConfigManager;
...
public class CrispyCoreCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        if (args[0].equalsIgnoreCase("test") || args[0].equalsIgnoreCase("rl") && sender.hasPermission("crispycore.reload")) {
            sendChat(sender, "#59cbe8Test");
            return true;
        }
        //Reload command
        if (args[0].equalsIgnoreCase("reload") || args[0].equalsIgnoreCase("rl") && sender.hasPermission("crispycore.reload")) {
